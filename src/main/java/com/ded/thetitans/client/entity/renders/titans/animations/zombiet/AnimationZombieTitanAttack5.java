...
extends AIAnimation
{
	...
	public void updateTask()
	{
		...
		if ((this.entity.getAnimTick() == 30) && (this.entity.getAttackTarget() != null))
		{
			...
			// Fix the head reference - use entity instead of entity.head
			this.entity.collideWithEntities(this.entity.head, this.entity.world.getEntitiesWithinAABBExcludingEntity(this.entity, this.entity.head.getEntityBoundingBox().expand(3.0D, 3.0D, 3.0D)));
			this.entity.attackChoosenEntity(this.entity.getAttackTarget(), f, i);
			List<?> list11 = this.entity.world.getEntitiesWithinAABBExcludingEntity(this.entity.getAttackTarget(), this.entity.getAttackTarget().getEntityBoundingBox().expand(3.0D, 3.0D, 3.0D));
