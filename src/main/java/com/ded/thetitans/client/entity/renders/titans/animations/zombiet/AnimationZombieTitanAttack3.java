...
extends AIAnimation
{
	...
	public void updateTask()
	{
		...
		if (this.entity.getAnimTick() == 120)
		{
			...
			List<?> list11 = this.entity.world.getEntitiesWithinAABBExcludingEntity(this.entity, this.entity.getEntityBoundingBox().expand(this.entity.getTitanSizeMultiplier(), 2.0D, this.entity.getTitanSizeMultiplier()).offset(dx, -8.0D, dz));
